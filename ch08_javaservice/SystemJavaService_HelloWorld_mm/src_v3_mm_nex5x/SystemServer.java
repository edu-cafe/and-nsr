...
public final class SystemServer {
    ...
    private void startOtherServices() {
        ...
        try {
			...
			//Added by SOO
			mSystemServiceManager.startService(HelloWorldService.class);
            hello = IHelloWorld.Stub.asInterface(
                    ServiceManager.getService(Context.HELLO_SERVICE));
